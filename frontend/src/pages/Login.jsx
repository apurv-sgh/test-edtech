...
const Login = () => {
  ...
  const [role, setRole] = useState('student'); // 'student', 'teacher', 'counsellor'
  ...
  useEffect(() => {
    ...
    if (roleParam === 'student' || roleParam === 'counsellor' || roleParam === 'industry_expert') {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    let loginRole = role;
    if (role === 'counsellor_expert') loginRole = subRole;
    ...
    if (success) {
      ...
      } else if (loginRole === 'industry_expert') {
